...
import { ArrowLeft, Mail, Lock, Chrome, Compass } from "lucide-react"
  ...
  return (
    <main className="min-h-full bg-background px-5 py-6">
      <div className="mx-auto flex min-h-[calc(100dvh-3rem)] max-w-md flex-col">
        <Link
          href="/sovellus/profiili"
          className="mb-8 grid h-10 w-10 place-items-center rounded-full bg-card shadow-sm"
        ...
        <div className="flex flex-1 flex-col justify-center pb-12">
          ...
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
            <button
              ...
              disabled={loading}
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-background px-4 py-3.5 font-medium text-foreground transition-transform active:scale-[0.99] disabled:opacity-60"
            >
            ...
            <form onSubmit={handleEmailSubmit} className="space-y-3">
              <label className="block">
                ...
                <span className="relative block">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-border bg-background py-3 pl-10 pr-3 text-sm outline-none focus:ring-2 focus:ring-forest/20"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-xl bg-forest px-4 py-3.5 font-semibold text-forest-foreground shadow-sm transition-transform active:scale-[0.99] disabled:opacity-60"
              >
            ...
            <button
              ...
              className="mt-5 w-full text-center text-sm font-medium text-brass"
            >
          ...
          <p className="mt-5 text-center text-xs leading-5 text-muted-foreground">
            Löytöretkeä voi käyttää myös ilman tiliä. Tili tarvitaan omien tallennusten ja muiden henkilökohtaisten tietojen säilyttämiseen.
          </p>
        </div>
      </div>
    </main>
